...
**ProgramNumber** | **string** | Specifies the number of the program for which you want the monitor to verify availability. | [optional] [default to null]
...
**VersionNumber** | **string** | Specifies the number of the version of the program for which you want the monitor to verify availability. | [optional] [default to null]
...
**Mode** | **string** | Specifies the protocol that the monitor uses to communicate with the target. The default value is tcp. The options are tcp (Specifies that the monitor uses the TCP protocol to communicate with the target object.) and udp (Specifies that the monitor uses the UDP protocol to communicate with the target object.) | [optional] [default to null]
