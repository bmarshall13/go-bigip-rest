...
**AdaptiveSamplingTimespan** | **int64** |  | [optional] [default to null]
...
**AdaptiveDivergenceValue** | **int64** |  | [optional] [default to null]
...
**Filename** | **string** | Specifies the full path and file name of the file that the system attempts to download. The health check is successful if the system can download the file. | [optional] [default to null]
...
**Adaptive** | **string** |  | [optional] [default to null]
