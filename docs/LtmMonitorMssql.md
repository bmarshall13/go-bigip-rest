...
**RecvRow** | **string** | Specifies the row in the database where the system expects the specified Receive String to be located. This is an optional setting, and is applicable only if you configure the send and recv options. | [optional] [default to null]
...
**Database** | **string** | Specifies the name of the database that the monitor tries to access. | [optional] [default to null]
...
**RecvColumn** | **string** | Specifies the column in the database where the system expects the specified Receive String to be located. This is an optional setting, and is applicable only if you configure the send and recv options. | [optional] [default to null]
