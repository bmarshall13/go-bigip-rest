...
**Username** | **string** | Specifies the user name if the monitored target requires authentication. The default value is none. | [optional] [default to null]
...
**Get** | **string** | Specifies a file associated with a service. The monitor uses the relative path to the service itself when attempting to locate the file. You are not required to specify a value for this option; however, if you elect to use this option you must also specify a service using the service option. | [optional] [default to null]
...
**Password** | **string** | Specifies the password if the monitored target requires authentication. The default value is none. | [optional] [default to null]
**Kind** | **string** | Kind of entity | [optional] [default to null]
**Name** | **string** | Name of entity | [optional] [default to null]
**Service** | **string** | Specifies a specific service on the SMB/CIFS for which you want to verify availability. This setting is optional. | [optional] [default to null]
...
**Server** | **string** | Specifies the NetBIOS name of the SMB/CIFS server for which this monitor checks for availability. You must specify a server for this monitor to function. | [optional] [default to null]
