...
**Filename** | **string** | Specifies the name of a file in the /config/eav/ directory on the system. The user-created file contains the send and expect data that the monitor uses for the monitor check. | [optional] [default to null]
